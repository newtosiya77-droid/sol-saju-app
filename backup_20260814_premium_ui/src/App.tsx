...
import { SajuAnalysisResult, SavedSajuItem, SavedGunghapResult, SavedWongukResult } from './types';
        ...
        <div className="w-[412px] h-[892px] bg-navy flex flex-col justify-between relative overflow-hidden shadow-2xl border border-gray-800">
          ...
          {(activeTab === 'storage' || activeTab === '보관함') ? (
            ...
            <div id="view-premium" className="flex flex-col h-full bg-[#0a0f1d] text-white relative">
              ...
              {/* 프리미엄 전용 콘텐츠 영역 (독립 화면 구조) */}
              <div className="flex-1 overflow-y-auto px-4 pt-4 pb-28 space-y-4 no-scrollbar">
                {/* 1. 상단 프리미엄 핵심 가치 안내 배너 */}
                <div className="bg-gradient-to-br from-[#13233b] via-[#101b2f] to-[#0c1322] border border-cyan-500/30 rounded-2xl p-4.5 shadow-lg relative overflow-hidden">
                  <div className="absolute top-0 right-0 w-32 h-32 bg-cyan-500/10 rounded-full blur-2xl pointer-events-none" />
                  <div className="flex items-center gap-2 mb-2">
                    <span className="px-2.5 py-0.5 rounded-full text-[11px] font-bold bg-cyan-400/20 text-cyan-300 border border-cyan-400/30">
                      PREMIUM AI SERVICE
                    </span>
                  </div>
                  <h3 className="text-base font-bold text-white mb-1 leading-snug">
                    전문 명리학 체계 & AI 정밀 심층 감명
                  </h3>
                  <p className="text-xs text-gray-300 leading-relaxed mb-3">
                    무료 기본 분석을 넘어, 인생의 중요한 전환점과 숨겨진 운의 흐름을 A4 최대 32장 분량으로 심층 해독합니다.
                  </p>

                  {/* 무료 vs 프리미엄 차이 한눈에 보기 바 */}
                  <div className="grid grid-cols-2 gap-2 pt-2.5 border-t border-gray-800/80 text-[11.5px]">
                    <div className="bg-[#090e1a]/80 rounded-xl p-2 border border-gray-800">
                      ...
                      <span className="text-gray-200">원국 4기둥 & 기초 오행 요약</span>
                    </div>
                    <div className="bg-cyan-950/40 rounded-xl p-2 border border-cyan-500/30">
                      ...
                      <span className="text-cyan-100">AI 정밀 분석 & A4 최대 32장</span>
                    </div>
                  </div>
                </div>

                {/* 2. PREMIUM 상품 3종 카드 목록 (일관된 크기 및 구조) */}
                <div className="space-y-4">
                  {/* === 상품 1: 💎 PREMIUM 분석 (궁합 전용) === */}
                  <div className="bg-[#121c33] border border-cyan-500/40 hover:border-cyan-400/70 rounded-2xl p-4.5 space-y-3.5 transition shadow-md relative overflow-hidden">
                    {/* 상단 뱃지 & 상품명 */}
                    <div className="space-y-1.5">
                      <div className="flex items-center justify-between">
                        ...
                        <span className="text-[11.5px] font-semibold text-cyan-300 bg-[#0c1424] px-2 py-0.5 rounded-md border border-cyan-800/60">
                          📄 A4 약 10장 분량
                        </span>
                      </div>
                      <h4 className="text-base font-extrabold text-white flex items-center gap-1.5">
                        <span>💎</span>
                        <span>PREMIUM 분석</span>
                      </h4>
                    </div>
                    ...
                    <div className="space-y-2 text-xs">
                      ...
                      <p className="text-[11px] text-cyan-400/90 font-medium pt-0.5">
                    ...
                    <div className="pt-2 border-t border-gray-800/80 flex items-center justify-between gap-3">
                      <div>
                        ...
                        <span className="text-lg font-black text-cyan-300">6,900원</span>
                      </div>
                      <button
                        type="button"
                        ...
                        className="px-6 py-2.5 rounded-xl bg-gradient-to-r from-cyan-600 to-cyan-500 hover:from-cyan-500 hover:to-cyan-400 text-black font-extrabold text-xs transition cursor-pointer shadow-lg shadow-cyan-500/20 active:scale-95 flex items-center justify-center gap-1.5"
                      >
                        <span>구매하기</span>
                        <span>➔</span>
                      </button>
                ...
                <div className="bg-[#0f172a]/60 border border-gray-800/70 rounded-xl p-3.5 text-center">
                  <p className="text-xs text-gray-400 leading-relaxed">
                    ✨ 프리미엄 상품 구매 시 정밀 AI 분석 보고서가 보관함에 영구 저장됩니다.
                  </p>
                </div>
              </div>
                ...
                >
                  ...
                  >
                    ...
                    <p className="text-[11px] text-gray-400 leading-relaxed">
                      ※ 현재 프리미엄 결제 연동 준비 중입니다. 사주 및 궁합 보관함에서 대상 데이터를 확인하실 수 있습니다.
                    </p>
